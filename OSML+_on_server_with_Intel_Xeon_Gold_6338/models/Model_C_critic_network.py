...
class CriticNetwork:
        ...
        def create_q_network(self,state_dim,action_dim):
                ...
                W4 = tf.Variable(tf.random_uniform([layer3_size,1],-1*W_FINAL,W_FINAL))
                b4 = tf.Variable(tf.random_uniform([1],-1*W_FINAL,W_FINAL))
        ...
        def train(self,y_batch,state_batch,action_batch):
                ...
                '''
                print("critic gradient:=====",self.sess.run(self.action_gradients,feed_dict={
                        self.state_input:state_batch,
                        self.action_input:action_batch,
