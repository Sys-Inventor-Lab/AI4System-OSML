...
def init():
    ...
    RPS_COLLECTED = {'img-dnn': [2000, 3000, 4000, 5000, 6000],
                    'xapian': [3600, 4400, 5200, 6000, 6800],
                    "moses": [2200, 2400, 2600, 2800, 3000],
                    'sphinx': [1, 4, 8, 12, 16],
                    'specjbb': [7000, 9000, 11000, 13000, 15000],
